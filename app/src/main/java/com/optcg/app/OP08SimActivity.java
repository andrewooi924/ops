...
/**
 * Pack-opening simulator for set OP08. All behaviour lives in
 * {@link BasePackSimActivity}; this class only supplies the per-set data.
 */
public class OP08SimActivity extends BasePackSimActivity {

    @Override
    protected PackSimConfig getConfig() {
        return new PackSimConfig.Builder("op08", R.layout.activity_op08_sim, R.drawable.op08_pack)
                .c(new int[]{
                        R.drawable.op08_003,
                        R.drawable.op08_004,
                        R.drawable.op08_005,
