...
/**
 * Collection screen for set OP05. All behaviour lives in
 * {@link BaseSetCollectionFragment}; this class only supplies the per-set data.
 */
public class OP05CollectionFragment extends BaseSetCollectionFragment {
    ...
    protected SetCollectionConfig getConfig() {
        return new SetCollectionConfig.Builder("op05", R.layout.fragment_op05_collection_fragment, R.id.op05_set_img,
                R.id.op05CollectionRecyclerView, R.id.op05ProgressCircle, R.id.op05ProgressText, 154)
                ...
                .row(R.id.op05CCollected, "c", 45)
                .row(R.id.op05UCCollected, "uc", 30)
                .row(R.id.op05RCollected, "r", 32)
                .row(R.id.op05SRCollected, "sr", 21)
                .row(R.id.op05LCollected, "l", 12)
                .row(R.id.op05SECCollected, "sec", 4)
                .row(R.id.op05SPCollected, "sp", 6)
                .row(R.id.op05MRCollected, "mr", 3)
                .row(R.id.op05ODACollected, "oda", 1)
                .build();
    }
}
