...
/**
 * Collection screen for set OP02. All behaviour lives in
 * {@link BaseSetCollectionFragment}; this class only supplies the per-set data.
 */
public class OP02CollectionFragment extends BaseSetCollectionFragment {
    ...
    protected SetCollectionConfig getConfig() {
        return new SetCollectionConfig.Builder("op02", R.layout.fragment_op02_collection_fragment, R.id.op02_set_img,
                R.id.op02CollectionRecyclerView, R.id.op02ProgressCircle, R.id.op02ProgressText, 154)
                .menuImages(Arrays.asList(
                        ...
                        R.drawable.op02_104,
                        R.drawable.op02_105,
                        R.drawable.op02_105_p1,
                        R.drawable.op02_106,
                        R.drawable.op02_107,
                        R.drawable.op02_108,
                        R.drawable.op02_108_p1,
                        R.drawable.op02_109,
                        R.drawable.op02_110,
                        R.drawable.op02_111,
                        R.drawable.op02_112,
                ...
                .row(R.id.op02CCollected, "c", 47)
                .row(R.id.op02UCCollected, "uc", 34)
                .row(R.id.op02RCollected, "r", 32)
                .row(R.id.op02SRCollected, "sr", 20)
                .row(R.id.op02LCollected, "l", 16)
                .row(R.id.op02SECCollected, "sec", 4)
                .row(R.id.op02MRCollected, "mr", 1)
                .build();
    }
}
