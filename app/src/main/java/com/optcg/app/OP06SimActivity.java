...
/**
 * Pack-opening simulator for set OP06. All behaviour lives in
 * {@link BasePackSimActivity}; this class only supplies the per-set data.
 */
public class OP06SimActivity extends BasePackSimActivity {

    @Override
    protected PackSimConfig getConfig() {
        return new PackSimConfig.Builder("op06", R.layout.activity_op06_sim, R.drawable.op06_pack)
                .c(new int[]{
                        R.drawable.op06_002,
                        R.drawable.op06_004,
                        R.drawable.op06_005,
