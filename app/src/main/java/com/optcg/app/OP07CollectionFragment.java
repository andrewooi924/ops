...
/**
 * Collection screen for set OP07. All behaviour lives in
 * {@link BaseSetCollectionFragment}; this class only supplies the per-set data.
 */
public class OP07CollectionFragment extends BaseSetCollectionFragment {
    ...
    protected SetCollectionConfig getConfig() {
        return new SetCollectionConfig.Builder("op07", R.layout.fragment_op07_collection_fragment, R.id.op07_set_img,
                R.id.op07CollectionRecyclerView, R.id.op07ProgressCircle, R.id.op07ProgressText, 150)
                ...
                .row(R.id.op07CCollected, "c", 45)
                .row(R.id.op07UCCollected, "uc", 30)
                .row(R.id.op07RCollected, "r", 32)
                .row(R.id.op07SRCollected, "sr", 20)
                .row(R.id.op07LCollected, "l", 12)
                .row(R.id.op07SECCollected, "sec", 4)
                .row(R.id.op07MRCollected, "mr", 1)
                .row(R.id.op07SPCollected, "sp", 6)
                .build();
    }
}
