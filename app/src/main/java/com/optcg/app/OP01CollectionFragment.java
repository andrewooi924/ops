...
public class OP01CollectionFragment extends Fragment {
    ...
    public void onAttach(@NonNull Context context) {
        ...
        if (context instanceof MainActivity) {
            cardRepository = ((MainActivity) context).getCardRepository();
        }
        else {
            throw new RuntimeException("Fragment must be attached to MainActivity");
        }
    }
...
//        toolbar.setNavigationOnClickListener(v -> requireActivity().onBackPressed());
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        setAdapter = new SetAdapter(getContext(), menuImages, cardRepository);
