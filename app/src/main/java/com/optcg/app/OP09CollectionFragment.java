...
/**
 * Collection screen for set OP09. All behaviour lives in
 * {@link BaseSetCollectionFragment}; this class only supplies the per-set data.
 */
public class OP09CollectionFragment extends BaseSetCollectionFragment {
    ...
    protected SetCollectionConfig getConfig() {
        return new SetCollectionConfig.Builder("op09", R.layout.fragment_op09_collection_fragment, R.id.op09_set_img,
                R.id.op09CollectionRecyclerView, R.id.op09ProgressCircle, R.id.op09ProgressText, 158)
                ...
                .row(R.id.op09CCollected, "c", 45)
                .row(R.id.op09UCCollected, "uc", 30)
                .row(R.id.op09RCollected, "r", 32)
                .row(R.id.op09SRCollected, "sr", 20)
                .row(R.id.op09LCollected, "l", 12)
                .row(R.id.op09SECCollected, "sec", 4)
                .row(R.id.op09MRCollected, "mr", 4)
                .row(R.id.op09SPCollected, "sp", 10)
                .row(R.id.op09GSPCollected, "gsp", 1)
                .build();
    }
}
