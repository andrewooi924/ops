...
/**
 * Pack-opening simulator for set OP10. All behaviour lives in
 * {@link BasePackSimActivity}; this class only supplies the per-set data.
 */
public class OP10SimActivity extends BasePackSimActivity {

    @Override
    protected PackSimConfig getConfig() {
        return new PackSimConfig.Builder("op10", R.layout.activity_op10_sim, R.drawable.op10_pack)
                .c(new int[]{
                        R.drawable.op10_008,
                        R.drawable.op10_010,
                        R.drawable.op10_012,
